...
import RetailOSLogo from './RetailOSLogo';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <a href="/" className="flex items-center">
              <RetailOSLogo variant="horizontal" size="md" />
            </a>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div className="col-span-1 md:col-span-2">
              <RetailOSLogo variant="horizontal" size="md" className="mb-4" />
              <p className="text-sm text-gray-400 mb-4">
                Conversion optimization for Shopify stores. We find what's broken and show you how to fix it.
              </p>
              <a
                href={DISCORD_URL}
                target="_blank"
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="mailto:contact@rolloutfactory.com" className="text-sm text-gray-400 hover:text-white transition-colors">Contact</a></li>
          ...
          <div className="border-t border-gray-800 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              <div className="text-center md:text-left">
                <p className="text-sm text-gray-400">© 2025 RolloutFactory Inc. All rights reserved.</p>
              </div>
