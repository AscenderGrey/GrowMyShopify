...
const ShopifyJoinPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    localStorage.setItem('shopifyWaitlistData', JSON.stringify(formData));
      ...
      <div className="max-w-2xl mx-auto px-6 py-12">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center px-4 py-2 rounded-full bg-green-100 border border-green-200 text-sm text-green-700 mb-6">
            ...
            Join the RetailOS Beta
          </div>
          
          <h1 className="text-4xl lg:text-5xl font-bold mb-6 text-gray-900">
            Get Early Access to<br />
            <span className="bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent">
              RetailOS for Shopify
            </span>
          </h1>
          
          <p className="text-xl text-gray-600 mb-8">
            Join the waitlist and be among the first to get an AI sales agent that actually converts. Limited beta spots available.
          </p>
          
          <div className="bg-yellow-100 border border-yellow-200 rounded-lg p-4 mb-8">
            <div className="flex items-center justify-center">
              <span className="mr-2">⚡</span>
              <span className="text-yellow-800 font-medium">Early users get a 2-month training head start</span>
            </div>
          </div>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors"
              >
                <option value="">Select your monthly sales range</option>
            ...
            <div className="flex items-start">
              ...
              <div className="ml-3 text-sm">
                <label htmlFor="earlyAccess" className="text-gray-700">
                  I'm interested in early access and willing to provide feedback during the beta period
                </label>
              </div>
            </div>
